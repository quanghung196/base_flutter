...
class StyleConstants {
  ...
  static TextStyle smallInfraRedText =
      smallText.copyWith(color: ColorConstants.red);
  static TextStyle smallCadetGreyText =
      smallText.copyWith(color: ColorConstants.grey);
}
